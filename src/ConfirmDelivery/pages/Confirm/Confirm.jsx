...
function Confirm() {
  ...
  const [showAltComponent, setShowAltComponent] = useState(false);
  ...
  return (
    <div className={styles["wrapper"]}>
      ...
      {/* info 섹션 대신 새로운 컴포넌트 조건부 렌더링 */}
      {showAltComponent ? (
        <AltInfo onConfirm={handleConfirm} />
      ) : (
        <div className={styles["info"]}>
          <div className={styles["info-content"]}>
            파손이나 반품의 의사가 있을 경우 판매자와 상의하시기 바랍니다.
            <br /> 상품 확인 및 수령을 완료하신 후에는 상품 미수령의 이유로{" "}
          ...
          <div className={styles["info-button"]}>
            <button className={styles["info-button-no"]} onClick={handleDeny}>
              아니요.
            </button>
            <button
              className={styles["info-button-yes"]}
